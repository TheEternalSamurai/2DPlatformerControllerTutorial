...
public class CharacterController2D : MonoBehaviour
{
	...
	public void recalculateDistanceBetweenRays()
	{
		...
		// horizontal
		var colliderUseableHeight = collider.bounds.size.y * Mathf.Abs( transform.localScale.y ) - ( 2f * _skinWidth );
		_verticalDistanceBetweenRays = colliderUseableHeight / ( totalHorizontalRays - 1 );

		// vertical
		var colliderUseableWidth = collider.bounds.size.x * Mathf.Abs( transform.localScale.x ) - ( 2f * _skinWidth );
